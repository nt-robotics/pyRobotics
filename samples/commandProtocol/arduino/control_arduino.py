...
from roboticsnt.commandProtocol.arduino.arduino_controllers import ArduinoCommand, ArduinoPinsController
...
class ControlArduinoThread(Thread):
    ...
    def __init__(self):
        ...
        self.connection = ArduinoPinsController(port)
    ...
    def run(self):
        while self.connection.is_connected():
            ...
            # Управление моторами перенесено из ArduinoConnection в отдельный класс ArduinoGeckoDriveG540Connection
    ...
    def test_digital_pins(self):
        pin = 13
        self.connection.set_pin_mode(pin, ArduinoPinsController.PIN_MODE_OUTPUT)

        time.sleep(1)
        self.connection.set_digital_pin(pin, ArduinoPinsController.LOW)
        time.sleep(1)
        self.connection.set_digital_pin(pin, ArduinoPinsController.HIGH)
        time.sleep(1)
        self.connection.set_digital_pin(pin, ArduinoPinsController.LOW)
        time.sleep(1)
        self.connection.set_digital_pin(pin, ArduinoPinsController.HIGH)
    ...
    def test_digital_listeners(self):
        self.connection.add_digital_pin_listener(8, ArduinoPinsController.PIN_MODE_INPUT_PULLUP)
        # self.connection.add_digital_pin_listener(32, ArduinoPinsController.PIN_MODE_INPUT_PULLUP)
        # self.connection.add_digital_pin_listener(30, ArduinoPinsController.PIN_MODE_INPUT_PULLUP)
        # self.connection.add_digital_pin_listener(28, ArduinoPinsController.PIN_MODE_INPUT_PULLUP)
